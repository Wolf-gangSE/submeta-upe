			...
			<div class="card-body" style="padding-top: 0.2rem">
				<div class="container">
					...
					<form method="POST" action="{{route('avaliador.enviarParecerBarema')}}" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label style="font-weight: bold">Comentário</label>
							<textarea class="form-control" minlength="20" id="comentario" name="comentario" rows="3">@if($trabalho->pivot->parecer) {{$trabalho->pivot->parecer}} @endif</textarea>
						</div>
